...
* DreamBooth ([https://github.com/XavierXiao/Dreambooth-Stable-Diffusion](https://github.com/XavierXiao/Dreambooth-Stable-Diffusion))

* LoRA ([https://github.com/cloneofsimo/lora](https://github.com/cloneofsimo/lora))
