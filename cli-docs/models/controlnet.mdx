...
![](/images/cli-docs/models/Screen%20Shot%202023-02-24%20at%204.21.42%20PM.png)


and you should get images like this as the output:


![](/images/cli-docs/models/Screen%20Shot%202023-02-24%20at%204.23.08%20PM.png)
...
**Important: This file should include each entry as a single line and** _**it should not be properly formatted as a JSON**_**. Here are the first three lines of the sample file:**
